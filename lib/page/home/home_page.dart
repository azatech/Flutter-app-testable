...
const titleAppName = 'TODO App';
const emptyListTitle = 'No TODO found';
const listViewHomePageKey = 'list_view_home_page_key';

String todoCardKey(int index) => 'item_${index}_text';
...
class _HomePageState extends State<HomePage> with ConfirmableDialogMixin {
  @override
  void initState() {
    super.initState();
